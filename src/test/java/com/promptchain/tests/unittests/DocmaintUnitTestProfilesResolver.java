...
public class DocmaintUnitTestProfilesResolver implements ActiveProfilesResolver {
  ...
  public String[] resolve(Class<?> testClass) {
    ...
    //-- @Import in DocmaintUnitTestClass) so profiles and property files of both the main application and the tests
    ...
    if (isWindows) {
      ...
      return new String[]{"winLocal", "test", "testUnit", "testUnitWinLocal"};
    } else {
      ...
      return new String[]{"linuxLocal", "test", "testUnit", "testUnitLinuxLocal"};
    }
  }
}